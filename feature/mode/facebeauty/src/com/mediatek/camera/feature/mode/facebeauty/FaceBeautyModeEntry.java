...
public class FaceBeautyModeEntry extends FeatureEntryBase {
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mMode = mResources.getString(mResources.getIdentifier("face_beauty_title",
                "string", mContext.getPackageName()));
        modeItem.mTitle = mResources.getString(mResources.getIdentifier("face_beauty_title",
                "string", mContext.getPackageName()));
        return modeItem;
    }
}
