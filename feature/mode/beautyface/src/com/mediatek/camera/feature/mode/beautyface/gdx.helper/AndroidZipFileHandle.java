...
import com.mediatek.camera.feature.mode.beautyface.gdx.helper.ZipResourceFile.ZipEntryRO;
...
public class AndroidZipFileHandle extends AndroidFileHandle {
    ...
    public FileHandle sibling(String name) {
        ...
        return Gdx.files.getFileHandle(new File(file.getParent(), name).getPath(), type); // this
                                                                                          // way
                                                                                          // we
                                                                                          // can
                                                                                          // find
