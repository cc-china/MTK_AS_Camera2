...
public class CamPostAlgo {
    ...
    private void stopService() {
        if (mService != null) {
//            if (SERVICE_STATUS_RUNNING.equals(SystemProperties.get(PREFIX_GET_SERVICE_STATUS + CAMPOSTALGO/*"init.svc.camerapostalgo"*/))) {
//                LogHelper.d(TAG, "Stop PostAlgo service");
//                SystemProperties.set(CMD_STOP_SERVICE/*"ctl.stop"*/, CAMPOSTALGO/*"camerapostalgo"*/);
//            }
            mService = null;
        }
...
//                SystemProperties.set(CMD_START_SERVICE/*"ctl.start"*/, CAMPOSTALGO/*"camerapostalgo"*/);
//            }
