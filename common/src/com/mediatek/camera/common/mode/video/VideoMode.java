...
public class VideoMode extends CameraModeBase {
    ...
    protected boolean initRecorder(boolean isStartRecording) {
        ...
        try {
            CameraSysTrace.onEventSystrace("videoMode.mediaRecorderinit", true);
            mRecorder.init(configRecorderSpec(isStartRecording));
            CameraSysTrace.onEventSystrace("videoMode.mediaRecorderinit", false);
    ...
    private void startRecording() {
        ...
        CameraSysTrace.onEventSystrace("videoMode.startRecording", true);
        ...
        try {
            CameraSysTrace.onEventSystrace("startRecording.start", true);
            mRecorder.start();
            CameraSysTrace.onEventSystrace("startRecording.start", false);
        ...
        CameraSysTrace.onEventSystrace("videoMode.startRecording", false);
        LogHelper.d(TAG, "[startRecording] - ");
    }
    ...
    private void initForHal3(boolean isStartRecording) {
        CameraSysTrace.onEventSystrace("videoMode.mediaRecorderPrepare", true);
        ...
        CameraSysTrace.onEventSystrace("videoMode.mediaRecorderPrepare", false);
        if (mSurface != null) {
    ...
    private void doInitMode() {
        CameraSysTrace.onEventSystrace("videoMode.doInitMode", true);
        initStatusMonitor();
        ...
        CameraSysTrace.onEventSystrace("videoMode.doInitMode", false);
    }
