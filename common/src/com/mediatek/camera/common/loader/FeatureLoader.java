...
import com.mediatek.camera.feature.mode.beautyface.BeautyFaceEntry;
...
public class FeatureLoader {
    ...
    private static final String BEAUTY_FACE_ENTRY_MODE = "com.mediatek.camera.feature.mode.beautyface.BeautyFaceEntry";
...
//        entries.put(MATRIX_SETTING, matrixDisplayEntry);
        ...
        IFeatureEntry beautyFaceEntry = new BeautyFaceEntry(context, context.getResources());
        beautyFaceEntry.setDeviceSpec(deviceSpec);
        entries.put(BEAUTY_FACE_ENTRY_MODE, beautyFaceEntry);
