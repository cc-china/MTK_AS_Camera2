...
// ===============xapi_apk facebeauty update 2019_10_30========================
...
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/mode/beautyface/res
...
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/mode/beautyface/src)
