...
public class CameraActivity extends PermissionActivity implements IApp {
    ...
    //xapi add start
    private BeautyFaceView mBeautyFaceView;
    //xapi add end
    ...
    protected void onCreateTasks(Bundle savedInstanceState) {
        CameraSysTrace.onEventSystrace("CameraActivity.onCreateTasks", true);
        ...
        CameraSysTrace.onEventSystrace("onCreateTasks.setContentView", true);
        setContentView(R.layout.activity_main);
        mBeautyFaceView = (BeautyFaceView) findViewById(R.id.facebeauty_preview_surface);
        CameraSysTrace.onEventSystrace("onCreateTasks.setContentView", false);
        ...
        profile.stop();
        CameraSysTrace.onEventSystrace("CameraActivity.onCreateTasks", false);
    }
    ...
    protected void onResumeTasks() {
        CameraSysTrace.onEventSystrace("CameraActivity.onResumeTasks", true);
        ...
        profile.stop();
        CameraSysTrace.onEventSystrace("CameraActivity.onResumeTasks", false);
    }

    @Override
    protected void onPauseTasks() {
        CameraSysTrace.onEventSystrace("CameraActivity.onPauseTasks", true);
        mIsResumed = false;
        super.onPauseTasks();
        ...
        resetScreenOn();
        CameraSysTrace.onEventSystrace("CameraActivity.onPauseTasks", false);
    }
    ...
    //xapi add start
    public BeautyFaceView getmBeautyFaceView() {
        return mBeautyFaceView;
    }
    //xapi add end
}
